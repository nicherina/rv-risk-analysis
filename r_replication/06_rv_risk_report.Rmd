...
This analysis uses a dataset of **538,704 vehicle sales records** to build and validate a depreciation model. Risk classification and stress testing are then applied to a **lease-realistic portfolio** — vehicles aged under 5 years with a 40% guaranteed buyback — comprising `r if(exists("rs")) format(nrow(rs), big.mark=",") else "~120,000"` contracts.

**Three headline findings:**

| Finding | Detail |
|---|---|
| Age is the primary risk driver | Each additional year reduces market value by 13.3%; vehicles 4–5 years old already show material RV gaps |
